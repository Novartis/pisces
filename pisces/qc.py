...
def qc_table(args, unknown_args):
    import warnings
    warnings.warn(
        "[DEPRECATION] The output tables generated by 'pisces summarize-qc tables' are empty and only exist for backward compatibility with older versions of PISCES. For generating fingerprint probabilities, please use the Picard CrosscheckFingerprints command instead.",
        DeprecationWarning
    )
    import pandas as pd
    import logging
